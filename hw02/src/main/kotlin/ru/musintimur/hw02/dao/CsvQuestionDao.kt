...
import ru.musintimur.hw02.config.TestFileNameProvider
import ru.musintimur.hw02.dao.dto.QuestionDto
import ru.musintimur.hw02.domain.Question
import ru.musintimur.hw02.exceptions.QuestionReadException
    ...
    override fun findAll(): List<Question> =
        runCatching {
            ...
            when (it) {
                ...
                else -> throw QuestionReadException("Failed to read questions from ${fileNameProvider.testFileName}", it)
            }
        }.getOrThrow()
}
