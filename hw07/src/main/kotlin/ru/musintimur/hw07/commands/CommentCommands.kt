...
import ru.musintimur.hw07.converters.CommentConverter
import ru.musintimur.hw07.services.CommentService
...
class CommentCommands(
    ...
    fun findCommentById(id: Long): String =
        commentService
            .findById(id)
    ...
    fun findCommentsByBookId(id: Long): List<String> =
        commentService
            .findAllByBookId(id)
            .map { commentConverter.commentToString(it) }
    ...
    fun deleteComment(id: Long) = commentService.deleteById(id)
}
